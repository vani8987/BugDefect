...
Страница доски показывает описание, роль текущего пользователя, статистику, список участников и статичный каркас будущей доски дефектов со статусами.
...
- добавить новый статус в UI-заготовке доски.
